 ...
 */
export async function generateLLMIdeas(provider, sweepData, delta, previousIdeas = [], userPortfolio) {
...
- Only Include Relevant Information -> Ignore stock in analysis if it does not have any relevance 

Output should be your analysis/report of the users portfolio, account orders, and the current OSINT + economic data:
Have a fun title and  seperate formatted sections for stocks that are relevant to keep analysis short 
